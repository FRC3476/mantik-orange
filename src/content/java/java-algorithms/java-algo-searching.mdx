...
public static void main(String[] args) {
    System.out.println(indexOf(new int[]{10, 20, 30}, 20));
}
```
...
public static void main(String[] args) {
    System.out.println(binarySearch(new int[]{10, 20, 30, 40, 50}, 30));
}
```
...
public static void main(String[] args) {
    System.out.println(lowerBound(new int[]{10, 20, 30, 40}, 25));
}
```
...
```java
Set<Integer> seen = new HashSet<>(Arrays.asList(10, 20, 30));
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(linearSearch(values, 20));
        System.out.println(linearSearch(values, 99));
    }
}
```
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(binarySearch(values, 50));
...
public class Main {
    ...
    public static void main(String[] args) {
        int[] values = {1, 2, 2, 2, 3, 5, 5};
        System.out.println(countOccurrences(values, 2));
        System.out.println(countOccurrences(values, 4));
    }
}
```
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(lowerBound(values, 25));
        System.out.println(lowerBound(values, 50));
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        int[] values = {40, 10, 70, 20, 90, 30};
        int[] queries = {20, 15, 90, 5, 40};
        // TODO: build a structure from values, then answer each query
