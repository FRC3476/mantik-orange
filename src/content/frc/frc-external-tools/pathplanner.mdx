...
<LinkGrid links={[{"label":"Swerve Drive Example","id":"swerve-drive-example"},{"label":"PathPlanner Docs","url":"https://pathplanner.dev/"},{"label":"PathPlannerLib API","url":"https://pathplanner.dev/api/java/"},{"label":"Command-Based Programming","id":"intro-to-command-based"},{"label":"Pose Estimation","id":"pose-estimation-intro"}]} title="Resources" section="frc" />
