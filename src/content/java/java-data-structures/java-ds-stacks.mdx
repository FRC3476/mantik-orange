...
All three operations touch only the last slot, so all three are instant. Growing happens rarely, exactly as in [ArrayLists](/java/java-ds-arraylists).
...
public class Main {
    public static void main(String[] args) {
        ...
        // TODO: push 1 through 5, then pop and print until empty
    }
}
```
...
class UndoSystem {
    ...
    void doAction(String action) {
        // TODO: push the action
    }

    void undo() {
        // TODO: pop if not empty
    }
...
public class Main {
    public static void main(String[] args) {
        UndoSystem system = new UndoSystem();
        system.doAction("moveArm");
        system.doAction("closeClaw");
        system.doAction("liftArm");
        system.undo();
        system.history();
    }
}
...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println(postfix("3 4 + 2 *"));
    }
}
```
