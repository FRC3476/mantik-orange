...
lessonId: overview
section: frc
description: Comprehensive FIRST Robotics Competition programming training
isOverview: true
order: 0
---
...
**5. Pose Estimation:** Tracking your robot's position on the field using odometry and vision. After odometry you choose PhotonVision or Limelight and stay on that path through setup, the vision subsystem, fusion, and calibration.

**6. Advanced Topics:** Simulation, log replay, unit testing, and path planning.

The code samples throughout follow Phoenix Tuner X `CommandSwerveDrivetrain` plus BLine for path following. AdvantageKit IO layers and log replay stay as later external-tools lessons. They are not how this course writes swerve.

<LinkGrid links={[{"label":"Environment Setup","id":"environment-setup"},{"label":"Intro to Motors","id":"intro-to-motors"},{"label":"Command-Based Guide","id":"intro-to-command-based"}]} title="Start Learning" section="frc" />
