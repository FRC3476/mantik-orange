...
Write `public static` on methods in this lesson so you can call them from `main` without building an object. `public` and `static` get a real definition in [Java Classes](/java/java-classes). `void` means the method does not `return` a value.
...
public class Main {
    ...
    public static void printRobotStatus(String robotName, double batteryLevel, boolean isActive) {
        // TODO: print name, battery level, and active / inactive
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        double speed1 = calculateSpeed(100, 5);
        double speed2 = calculateSpeed(50, 2.5);
        System.out.println("Robot 1 speed: " + speed1);
        System.out.println("Robot 2 speed: " + speed2);
    ...
    public static double calculateSpeed(double distance, double time) {
        // TODO: return a speed from distance and time
        return 0.0;
    }

    public static double calculateDistance(double x1, double y1, double x2, double y2) {
        // TODO: return the distance between the two points
        return 0.0;
    }
}
```
...
public class Main {
    ...
    public static void runCompetitionSequence() {
        // TODO: call check, then auto and teleop if ready, then shutdown
    }

    public static void performSystemCheck() {
        // TODO: call the battery, motor, and sensor checks
    }
    ...
    public static boolean isRobotReady() {
        // TODO: return whether the robot is ready
        return false;
    }
