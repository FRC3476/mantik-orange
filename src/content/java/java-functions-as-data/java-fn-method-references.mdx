...
public class Main {
    public static void main(String[] args) {
        ...
        // TODO: convert using a method reference
        System.out.println(numbers);
    }
}
```
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // TODO: sort with Comparator.comparingInt and a method reference
        for (Motor m : motors) {
            System.out.println(m.getPort());
        }
    }
...
public class Main {
    public static void main(String[] args) {
        Supplier<ArrayList<String>> make = null; // TODO: constructor reference
        if (make != null) {
            ArrayList<String> first = make.get();
            ArrayList<String> second = make.get();
...
public class Main {
    public static void main(String[] args) {
        Function<Integer, Integer> f = x -> {
            int doubled = x * 2;
            return doubled;
            // TODO: explain why this cannot become a method reference
        };
