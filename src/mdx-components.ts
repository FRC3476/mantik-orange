...
import VisionPathChooser from '@/components/frc/VisionPathChooser.astro';
import VisionPathAction from '@/components/frc/VisionPathAction.astro';
import ChangeVisionSystem from '@/components/frc/ChangeVisionSystem.astro';
