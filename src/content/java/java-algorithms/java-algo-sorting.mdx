...
List<String> names = new ArrayList<>(Arrays.asList("carol", "alice", "bob"));
...
motors.add(new Motor("intake", 2));
motors.add(new Motor("shooter", 1));
motors.add(new Motor("arm", 1));
...
List<Motor> motors = new ArrayList<>();
motors.add(new Motor("shooter", 2));
motors.add(new Motor("intake", 1));
motors.add(new Motor("arm", 1));
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(insertionSort(sorted));
        System.out.println(Arrays.toString(sorted));
        System.out.println(insertionSort(reversed));
        System.out.println(Arrays.toString(reversed));
    }
}
```
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // TODO: sort by key; equal keys should keep their original order
        for (int i = 0; i < items.length; i++) {
            System.out.print(items[i].id + " ");
        }
        System.out.println();
    }
}
...
public class Main {
    public static void main(String[] args) {
        ...
        motors.add(new Motor("shooter", 1));
        motors.add(new Motor("arm", 1));
        // TODO: sort by port descending, then name ascending
        for (int i = 0; i < motors.size(); i++) {
            Motor m = motors.get(i);
            System.out.println(m.name + ":" + m.port);
        }
    }
}
```
