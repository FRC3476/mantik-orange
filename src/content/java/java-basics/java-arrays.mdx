...
```java
class Competition {
    // Add fields for name, location, number of teams, and date

    Competition(String name, String location, int numTeams, String date) {
        // Store the values
    }
}
...
public class Main {
    public static void main(String[] args) {
        Competition[] season = new Competition[5];
        // Create Competition objects, store them in the array, and print them
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            // Read name, location, team count, and date
            // Store a Competition in competitions[i]
        }
...
class Competition {
    ...
    public String toString() {
        return name + " in " + location + " (" + numTeams + " teams)";
    }
}

public class Main {
    static void filterByTeamCount(Competition[] competitions, int minTeams) {
        // Print competitions with at least minTeams teams
    }

    static void filterByLocation(Competition[] competitions, String location) {
        // Print competitions whose location contains this text
    }
