...
When you need every ordering of N ≤ 10 items, generate permutations recursively. The general technique is covered in [Recursive Complete Search](/java/java-algo-backtracking); for small fixed sizes, nested loops with distinctness checks are simpler:
...
<LinkGrid
  ...
  section="comp"
  links={[
    {"label":"Backtracking","url":"/java/java-algo-backtracking"},
