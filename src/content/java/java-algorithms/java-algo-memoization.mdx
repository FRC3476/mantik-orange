...
Prerequisite: [Recursion](/java/java-algo-recursion). This is for counting and path-count problems, not daily robot code.
...
public static void main(String[] args) {
    System.out.println(fibTable(10));
}
```
...
<ContentTable
  ...
  rows={[
    ...
    ["Easier to write from a recurrence", "Yes", "No &mdash; you must find the order"],
...
public static void main(String[] args) {
    System.out.println(fibTwoVars(10));
}
```
...
public class Main {
    ...
    public static void main(String[] args) {
        int n = 10; // raise n after memoizing
        long start = System.nanoTime();
        int result = fib(n);
        long elapsedNs = System.nanoTime() - start;
        System.out.println(result);
        System.out.println(elapsedNs + " ns");
    }
}
```
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(fibTwoVars(n));
    }
}
```
...
```java
public class Main {
    static int fewestCoins(int[] coins, int target) {
    ...
    public static void main(String[] args) {
        int[] coins = {1, 3, 4};
        int target = 6;
        System.out.println(fewestCoins(coins, target));
    }
}
```
