...
<RulesBox title="Optional track">

You can do the same Git work in the terminal ([Local Git Workflow](/java/local-workflow)) or here. Desktop still creates real commits. Use this page after [Installing Git](/java/install-git) if you prefer buttons. It is not a late beginner lesson — it is a parallel path.
