...
public class Main {
    public static void main(String[] args) {
        ...
        /*
        Poor structure:
        - total is declared inside the loop, so it resets every pass
        - results are printed inside the loop at quit
        */
...
public class Main {
    public static void main(String[] args) {
        ...
        // TODO: declare sum, count, min, and max before the loop

        while (true) {
            System.out.println("Enter a reading (0 to stop):");
            double reading = Double.parseDouble(scanner.nextLine());

            if (reading == 0) {
                break;
            }

            // TODO: update the variables declared above
        }

        // TODO: print results after the loop
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        ...
        for (int step = 1; step <= 5; step++) {
            double reading = Math.random() * 120;
            totalReadings++;
            // TODO: skip out-of-range readings, then add valid ones to sum
        }

        // TODO: print diagnostic results after the loop
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // TODO: update sum, count, min, and max
        }

        // TODO: print sum, count, min, max, and average after the loop
    }
}
```
