...
With it on, every tunable is a live NetworkTables entry. A dashboard that fails to connect, a stale value left over from practice, or someone typing in the pit all become ways for the robot to behave differently than the code says.
...
2. Deploy once.
3. Open the dashboard; the entries appear under the tunable table.
4. Run the mechanism, change a value, watch the effect immediately.
