...
<LinkGrid
  ...
  links={[
    ...
    { "label": "Interview Preparation", "id": "comp-interview-prep", "description": "Applying these skills to technical interviews" }
  ]}
/>
...
<LinkGrid
  ...
  section="comp"
  links={[
    { "label": "Setting Up Java Locally", "id": "cp-java-setup", "description": "JDK, compiling, testing against sample input" },
...
<LinkGrid
  ...
  links={[
    ...
    { "label": "Algorithms", "id": "comp-sorting", "description": "Sorting, searching, DP, greedy, backtracking" },
