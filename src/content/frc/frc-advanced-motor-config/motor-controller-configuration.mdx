...
<ContentTable
  ...
  rows={[
    ["<code>DutyCycleOut</code>", "Raw output, &minus;1 to 1", "Rollers, conveyors &mdash; anything open-loop"],
...
<LinkGrid links={[{"label":"Subsystems","id":"subsystems"},{"label":"Motor PID Control","id":"motor-pid-control"},{"label":"Current Limiting Details","id":"motor-current-limiting"},{"label":"Phoenix 6 Control Requests","url":"https://v6.docs.ctr-electronics.com/en/stable/docs/api-reference/api-usage/control-requests.html"}]} title="Resources" section="frc" />
