...
The first row is worth emphasising: if every edge costs the same, Dijkstra is unnecessary overhead. Plain BFS is simpler and faster. See [Graph Representation and Traversal](/comp/cp-graph-basics).
