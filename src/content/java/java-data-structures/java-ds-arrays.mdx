...
If you need a refresher on the syntax first, see [Arrays](/java/java-arrays) in Java Basics.
...
```java
int[] readings = {120, 118, 125, 130, 122};
...
That copy touches every element, so it costs time proportional to the size. Doing it once is fine. Doing it every time you add a value is slow, and it is the reason [ArrayLists](/java/java-ds-arraylists) exist.
...
ReadingBuffer buf = new ReadingBuffer();
buf.addReading(120);
buf.addReading(118);
buf.addReading(125);
System.out.println(buf.average());
```
...
- **Assuming a copy is a copy.** `int[] b = a;` makes both names refer to the *same* array. Changing `b[0]` changes `a[0]`. Use `a.clone()` or `Arrays.copyOf(a, a.length)` for a real copy. See [Objects and References](/java/java-objects-references).
...
If the size changes as the program runs, use an [ArrayList](/java/java-ds-arraylists). If you insert and remove at the ends constantly, look at [Deques](/java/java-ds-deques).
...
public class Main {
    public static void main(String[] args) {
        ...
        int total = 0;
        // TODO: fill numbers with 1 through 10 and add them into total
...
public class Main {
    static int largest(int[] arr) {
        // TODO: return the largest value; handle an empty array
        return 0;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(largest(new int[] {}));
    }
}
```
...
public class Main {
    static void reverse(int[] arr) {
        // TODO: reverse arr in place, without a second array
    }
...
public class Main {
    static int[] append(int[] arr, int value) {
        // TODO: return a new array with value appended
        return arr;
    }

    public static void main(String[] args) {
        int[] values = {1, 2, 3};
        int[] longer = append(values, 4);
...
public class Main {
    public static void main(String[] args) {
        ...
        // TODO: print the sum of each row and each column
    }
}
```
