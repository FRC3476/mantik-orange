...
<ContentTable
  ...
  rows={[
    ["<code>ArrayDeque</code>", "Default choice &mdash; fastest, least memory"],
...
RecentReadings buf = new RecentReadings();
for (int i = 0; i < 55; i++) {
    buf.record(i * 0.1);
}
System.out.println(buf.recent.size());
```
...
public class Main {
    public static void main(String[] args) {
        ...
        // TODO: add 1 through 5 alternately to the front and back, then print
...
class RecentReadings {
    Deque<Double> recent = new ArrayDeque<Double>();

    void record(double reading) {
        // TODO: add at the back; drop the oldest if size exceeds 20
    }
...
class Editor {
    Deque<String> undoStack = new ArrayDeque<String>();
    Deque<String> redoStack = new ArrayDeque<String>();
...
public class Main {
    public static void main(String[] args) {
        ...
        editor.undo();
        editor.redo();
        System.out.println(editor.undoStack);
        System.out.println(editor.redoStack);
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        ...
        // TODO: print the maximum of every window of width k
    }
}
```
