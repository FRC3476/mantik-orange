...
public class RobotCalculations {
    public static void main(String[] args) {
        ...
        // Distance formula. Math.sqrt is a library method: square root of its argument.
...
public class Main {
    public static void main(String[] args) {
        ...
        // Calculate area (length × width) and print it
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        ...
        // Compute average speed with floating-point division, then print it
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        double currentBattery = 85.5;
        double consumptionRate = 3.2;
        double lowBatteryThreshold = 20.0;

        // Calculate remaining time above the threshold and print it
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        ...
        // Print integer division and floating-point division of these values
    }
}
```
