...
<RulesBox title="Overload vs override">

**Overload:** same class, same method name, **different** parameter lists. The compiler picks which one. That is this lesson.

**Override:** a subclass replaces a method that already has the **same** name and parameters. That is [Inheritance](/java/java-inheritance).
...
public class FRCDrivetrain {
    ...
    public void driveForTime(double forward, double strafe, double rotate, double seconds) {
        ...
        System.out.println("Would wait " + seconds + " seconds, then stop");
        this.drive(0, 0, 0);
    }
}
...
class Servo {
    ...
    // TODO: constructor that takes just a name (standard range)
    // TODO: constructor that takes name and a custom range
    // TODO: constructor that takes name, range, and reversed
}
...
public class Main {
    public static void main(String[] args) {
        // Construct:
        //   new Servo("Claw")
        //   new Servo("Arm", 0.1, 0.9)
        //   new Servo("Wrist", 0.0, 0.8, true)
    }
}
```
...
class Sensor {
    ...
    // TODO: constructor that takes the sensor type

    // TODO: readSensor() — one reading
    // TODO: readSensor(int numReadings) — average several
    // TODO: readSensor(int numReadings, int delayMs)
}

public class Main {
    public static void main(String[] args) {
        // Construct: new Sensor("Ultrasonic")
        // Then call:
        //   readSensor()
        //   readSensor(3)
        //   readSensor(5, 100)
...
```java
class Autonomous {
    // TODO: drive() with no args
    // TODO: drive(double power)
    // TODO: drive(double power, double seconds)
}
...
```java
class Competition {
    // TODO: score(int points)
    // TODO: score(int points, String reason)
    // TODO: time(double seconds)
    // TODO: time(int minutes, int seconds)
}

public class Main {
    public static void main(String[] args) {
        Competition match = new Competition();
        // Call:
        //   match.score(5)
        //   match.score(5, "auto")
        //   match.time(90.0)
