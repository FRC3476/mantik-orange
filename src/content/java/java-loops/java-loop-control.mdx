...
This example is shown so you can see why the condition never becomes false. It would run forever, so it is not runnable in the browser.
...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // TODO: if number is invalid, continue
            // TODO: otherwise accept the number
        }
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // TODO: handle the other menu choices
        }
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Enter sensor reading (-1 to stop):");
            int reading = Integer.valueOf(scanner.nextLine());
            ...
            // TODO: if reading is out of range, continue
            // TODO: otherwise process the reading
        }
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("Enter a command (0 = emergency stop):");
            ...
            // TODO: add other emergency break conditions
        }
    }
}
```
