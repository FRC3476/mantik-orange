    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                ...
                // TODO: use index with the sensors array and print a reading
            } catch (NumberFormatException e) {
                // TODO: handle the error
            } catch (ArrayIndexOutOfBoundsException e) {
                // TODO: handle a bad index
            }
        }

        System.out.println("Sensor system shut down.");
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.print("Motor index 0-3 (-1 to quit): ");
            String input = scanner.nextLine();
            try {
                int index = Integer.parseInt(input);
                if (index == -1) {
                ...
                // TODO: check the index, then set powers[index] if the value is in range
            } catch (NumberFormatException e) {
                // TODO: handle the error
            } catch (ArrayIndexOutOfBoundsException e) {
                // TODO: handle a bad index
...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("1 load  2 display  3 validate  0 exit");
            ...
            try {
                ...
                // TODO: handle other commands; throw if the number is not valid
            } catch (NumberFormatException e) {
                // TODO: handle the error
            } catch (IllegalArgumentException e) {
                // TODO: handle a bad command value
            }
        }
...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            while (true) {
                System.out.print("Enter step number (0 to finish): ");
                String input = scanner.nextLine();
                try {
                    ...
                    // TODO: run this step (init, move, score, ...)
                } catch (NumberFormatException e) {
                    // TODO: handle the error
                } catch (Exception e) {
                    // TODO: handle a failed step
                }
            }
        } finally {
