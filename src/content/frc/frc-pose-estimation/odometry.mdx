...
**Integrating Wheel Movements:** Encoders measure shaft rotation. Combined with wheel diameter — and gear ratio, if the encoder is on the motor shaft rather than the wheel shaft — odometry converts those counts into distance traveled.
...
- Implement sensor fusion (see [Fused Pose Estimation](/frc/vision-pose-estimation-fusion) and [Choose Your Vision System](/frc/vision-system-choice))
