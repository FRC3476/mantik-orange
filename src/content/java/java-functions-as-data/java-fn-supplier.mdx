...
<ContentTable
  title="The interfaces you will actually use"
...
class Sensor {
    double value = 1.5;
    double getDistance() { return value; }
}
...
class DriveCommand {
    DriveCommand(double y) {
        System.out.println("frozen y: " + y);
    }

    DriveCommand(DoubleSupplier axis) {
        System.out.println("live y: " + axis.getAsDouble());
    }
}
...
static String buildExpensiveReport() {
...
public class Main {
    static List<Integer> filter(List<Integer> items, Predicate<Integer> test) {
        // TODO: keep items that pass test.test
    ...
    public static void main(String[] args) {
        ...
        Predicate<Integer> above100 = r -> false;
...
public class Main {
    static void greet(Consumer<String> action) {
        // TODO: accept three names
    }

    public static void main(String[] args) {
        greet(name -> System.out.println(name));
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        Function<Integer, Integer> doubled = x -> 0;
        Function<Integer, String> describe = x -> "";
        Function<Integer, String> combined = null;
        if (combined != null) {
...
public class Main {
    static double distance = 1.5;

    public static void main(String[] args) {
        DoubleSupplier reading = () -> 0.0;
        System.out.println(reading.getAsDouble());
        distance = 3.0;
        System.out.println(reading.getAsDouble());
    }
}
