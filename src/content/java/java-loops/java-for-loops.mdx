...
public class Main {
    public static void main(String[] args) {
        ...
        for (int row = 1; row <= TABLE_SIZE; row++) {
            ...
            // TODO: start a new line after each row
        }
    }
}
```
...
public class Main {
    public static void main(String[] args) {
        ...
        for (int sample = 0; sample < SAMPLES; sample++) {
            double reading = 50.0 + (Math.random() - 0.5) * 10.0;
            // TODO: add reading to sum and print progress
        }
...
public class Main {
    public static void main(String[] args) {
        ...
        // TODO: use a for loop to compute n factorial into result
...
public class Main {
    public static void main(String[] args) {
        String[] motorNames = {"frontLeft", "frontRight", "backLeft", "backRight"};
        double[] speeds = {0.25, 0.5, 0.75, 1.0};

        for (int m = 0; m < motorNames.length; m++) {
            for (int s = 0; s < speeds.length; s++) {
                // TODO: print this motor name and speed
            }
        }
    }
}
