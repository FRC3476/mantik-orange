...
class FRCRobot {
    ...
    FRCRobot(String name, int number) {
        this.teamName = name;
        this.teamNumber = number;
        this.batteryLevel = 100.0;
    }
...
class FRCRobot {
    ...
    double getBatteryLevel() { return this.batteryLevel; }
...
class FRCRobot {
    ...
    public boolean equals(Object compared) {
        ...
        if (compared == null || !(compared instanceof FRCRobot)) return false;
        FRCRobot other = (FRCRobot) compared;
        return teamName.equals(other.teamName) && teamNumber == other.teamNumber;
    }
...
public class Main {
    public static void main(String[] args) {
        Sensor a = new Sensor("Ultrasonic", "US-001");
        Sensor b = new Sensor("Ultrasonic", "US-001");
        Sensor c = new Sensor("Gyro", "GY-001");
...
class Robot {
    ...
    Robot copy() {
        // TODO: return a new robot with its own copy of the sensors
        return null;
    }
}
...
public class Main {
    public static void main(String[] args) {
        Robot original = new Robot("Storm");
        original.addSensor(new Sensor("Ultrasonic", "US-001"));
        original.addSensor(new Sensor("Gyro", "GY-001"));
        // TODO: Robot clone = original.copy();
        // TODO: change original, then print both robots' sensors
        System.out.println(original.teamName + " sensors: " + original.sensors.size());
    }
}
```
...
class Competition {
    Robot[] roster = new Robot[4];

    void printRoster() {
        // TODO: print each robot; skip null slots without crashing
    }
}

public class Main {
    public static void main(String[] args) {
        Competition meet = new Competition();
        meet.roster[0] = new Robot("Alpha");
        meet.roster[1] = null;
        meet.roster[2] = new Robot("Gamma");
        meet.roster[3] = new Robot("Delta");
        meet.printRoster();
    }
}
```
...
class Robot {
    ...
    Robot(String name, double batteryLevel) {
        this.name = name;
...
public class Main {
    static void findLowBattery(Robot[] roster) {
        // TODO: print robots whose battery is low
    }

    public static void main(String[] args) {
        Robot[] roster = new Robot[4];
        roster[0] = new Robot("Alpha", 15.0);
        roster[1] = new Robot("Beta", 80.0);
        roster[2] = null;
        roster[3] = new Robot("Gamma", 8.0);
        findLowBattery(roster);
    }
}
```
