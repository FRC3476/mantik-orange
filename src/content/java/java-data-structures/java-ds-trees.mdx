...
Come back after [Linked Lists](/java/java-ds-linked-lists) and [Recursion](/java/java-algo-recursion). Walking a tree in every order is [Tree Traversals](/java/java-algo-tree-traversals). First-year teleop does not need this page.

</RulesBox>

### Branching instead of chaining

A [linked list](/java/java-ds-linked-lists) node points at one other node. A tree node points at several. That single change gives you a structure for anything hierarchical.
...
Level-order is the odd one out — it needs a [queue](/java/java-ds-queues) rather than recursion:
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(contains(root, 4));
    }
}
```
...
<ExerciseBox title="Practice" description="Use the Node class in each starter for 1–4.">
...
public class Main {
    static void preorder(Node node) {
        // TODO: print this node, then the left subtree, then the right
    }

    static void inorder(Node node) {
        // TODO: print the left subtree, then this node, then the right
    }

    static void postorder(Node node) {
        // TODO: print the left subtree, then the right, then this node
    }
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] values = {20, 40, 60, 80, 10, 35, 65, 25, 45, 55};
...
public class Main {
    public static void main(String[] args) {
        ...
        // TODO: print the smallest, the largest, and the nearest value at or above 50
    }
}
```
